...
const createEditTemplate = (point, pointDestinations) => {
  const {id, eventType, destination, destinationDescription, eventCost, isDisabled = false, isDeleting = false, isSaving = false} = point;
...
export default class EditPoint extends Smart {
  ...
  _closeClickHandler(evt) {
    evt.preventDefault();
    this.updateData(this._data, this._point, false);
